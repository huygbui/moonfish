...
Revision ID: 1526ae7f28df
Revises: 
Create Date: 2025-07-26 20:24:38.875927
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_user_subscription_tier_id'), 'user', ['subscription_tier_id'], unique=False)
    op.create_table('podcast',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(), nullable=False),
    sa.Column('format', sa.Enum('interview', 'conversation', 'story', 'analysis', name='format'), nullable=False),
    sa.Column('voice1', sa.Enum('maya', 'jake', 'sofia', 'alex', name='voice'), nullable=False),
    sa.Column('voice2', sa.Enum('maya', 'jake', 'sofia', 'alex', name='voice'), nullable=True),
